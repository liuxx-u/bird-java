 ...
 * @since 2021/5/7
 */
public class StandardState<C extends StateContext> {

    private final String stateId;

    private final Map<String, StateProcessor<C>> eventMap;

    public StandardState(String stateId, Map<String, StateProcessor<C>> eventMap) {
     ...
     * @return target state
     */
    public String process(String eventName, C ctx) {
        StateProcessor<C> stateProcessor = this.obtainProcessor(eventName);
     ...
     */
    public void setProcessor(String eventName, StateProcessor<C> processor) {
     ...
     * @return processor
     */
    public StateProcessor<C> obtainProcessor(String eventName) {
