...
public class WebfluxSsoClientAutoConfiguration {
    ...
    public WebfluxSsoClient ssoClient(SsoClientProperties clientProperties, IRemoteTicketHandler remoteTicketHandler){
        return new WebfluxSsoClient(clientProperties,remoteTicketHandler);
    }
