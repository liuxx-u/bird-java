...
public class CmsAttributeServiceImpl extends AbstractServiceImpl<CmsAttribute> implements CmsAttributeService,IEventHandler<TestEventArg> {
    ...
    public void HandleEvent(TestEventArg eventArg) {
        System.out.println("notify cms======22");
    }
}
